package com.example.topfoodnow.service.user.impl;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public User addUser(UserRegisterRequest requestDTO) throws IOException {
        User user = new User();
    ...
    @Override
    public UserProfileResponse getUserProfileForPublicRecommend(Integer userId) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new EntityNotFoundException("未找到用戶 ID: " + userId));
