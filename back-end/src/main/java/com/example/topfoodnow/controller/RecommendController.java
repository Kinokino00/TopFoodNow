...
public class RecommendController {
    ...
    public ResponseEntity<List<RecommendResponseDTO>> getRecommendsByStoreId(
        ...
        List<RecommendResponseDTO> recommends = recommendService.getRecommendsByStoreId(storeId);
    ...
    public ResponseEntity<RecommendResponseDTO> updateRecommendProcess(
        ...
        try {
            ...
            logger.info("用戶 {} 更新推薦成功，推薦ID: {}", currentUserModel.getEmail(), recommendRequestDTO.getId());
