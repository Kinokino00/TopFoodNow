package com.example.topfoodnow.controller.storecategory.response;
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "添加或更新店家分類後的響應對象")
public class AddOrUpdateStoreCategoriesResponse {
    ...
    private List<GetAllCategoriesData> categories;
}
