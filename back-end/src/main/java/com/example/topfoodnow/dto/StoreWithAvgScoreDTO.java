...
public class StoreWithAvgScoreDTO {
    ...
    public StoreWithAvgScoreDTO(Integer recommendId, Integer userId, Integer storeId, String storeName, Integer score) {
        this.id = recommendId;
        this.userId = userId;
    ...
    public StoreWithAvgScoreDTO(Integer recommendId, Integer userId, Integer storeId, String storeName, Integer score, String photoUrl) {
        this.id = recommendId;
        this.userId = userId;
        this.storeId = storeId;
        this.storeName = storeName;
